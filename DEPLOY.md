...
| `CORS_ORIGINS` | comma-separated allowed origins, e.g. `https://share-crops-v2.vercel.app,http://localhost:5173` | no |
| `DEFAULT_ORIGIN` | e.g. `https://share-crops-v2.vercel.app` | no |
...
supabase secrets set \
  ...
  CORS_ORIGINS="https://share-crops-v2.vercel.app,http://localhost:5173,http://localhost:4321" \
...
vercel env add VITE_FALLBACK_API_URL  # https://share-crops-v2.vercel.app/api/make-server-dd877831
```
