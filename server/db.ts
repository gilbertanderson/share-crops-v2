...
//
// The Supabase JS client (PostgREST + RPC) is the only database driver. CRUD
// goes through `.from(table)`, transactional/geo operations through `.rpc()`,
// and drift-free aggregates through the `*_view` views.
//
