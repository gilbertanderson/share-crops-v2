...
//
// Default: Supabase Storage — `/upload` stores the file and returns a 1-year
// signed URL persisted on the listing/profile row. Those URLs expire.
//
...
// same-origin serving URL (`…/images/<key>`) backed by GET /images/:key.
...
// any runtime (including this Vercel function) — it does not require hosting on
// Netlify. Netlify Image CDN (`/.netlify/images`) is edge-served by Netlify and
// is unavailable on other hosts; not wired into the client here.
